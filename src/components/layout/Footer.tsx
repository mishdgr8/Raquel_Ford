                ...
                <div className={styles.grid}>
                    ...
                    <div className={styles.social}>
                        ...
                        <div className={styles.icons} style={{ flexWrap: 'wrap' }}>
                            <a href="https://www.instagram.com/raquelfordmedia/" target="_blank" rel="noopener noreferrer"><Instagram size={20} /></a>
                            <a href="https://x.com/raquelfordmedia" target="_blank" rel="noopener noreferrer"><Twitter size={20} /></a>
                            <a href="https://www.facebook.com/profile.php?id=61565446950545" target="_blank" rel="noopener noreferrer"><Facebook size={20} /></a>
                            {/* TikTok */}
                            <a href="https://www.tiktok.com/@raquelfordmedia" target="_blank" rel="noopener noreferrer">
                                <svg width={20} height={20} viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z" />
                                </svg>
                            </a>
                            {/* LinkedIn */}
                            <a href="https://www.linkedin.com/company/raquel-ford-media/" target="_blank" rel="noopener noreferrer">
                            ...
                            {/* YouTube */}
                            <a href="https://www.youtube.com/@raquelfordmedia" target="_blank" rel="noopener noreferrer">
                            ...
                            {/* Threads */}
                            <a href="https://www.threads.com/@raquelfordmedia" target="_blank" rel="noopener noreferrer">
                                <svg width={20} height={20} viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div className={styles.newsletter}>
                        ...
                        <div className={styles.supportArea}>
                            ...
                            <a href="mailto:momentswithraquel@gmail.com?subject=Support%20Media" className={styles.supportButton}>
                                DONATE
                            </a>
                        </div>
                    </div>
