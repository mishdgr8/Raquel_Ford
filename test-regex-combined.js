...
while ((match = twitterRegex.exec(html)) !== null) {
    ...
    console.log("ID 1:", match[1]);
    console.log("ID 2:", match[2]);
...
while ((match = twitterRegex.exec(html2)) !== null) {
    console.log("Matched2:", match[0]);
    const id = match[1] || match[2];
    console.log("Final ID2:", id);
}

const html3 = `<p><a href="https://x.com/abc/status/67890">https://x.com/abc/status/67890</a></p>`;
while ((match = twitterRegex.exec(html3)) !== null) {
    console.log("Matched3:", match[0]);
    const id = match[1] || match[2];
    console.log("Final ID3:", id);
}
